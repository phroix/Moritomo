...
const KoujouOverview = () => {
  ...
  const renderCalendarWithSelectableDate = () => {
    return (
      <Fragment>
        <Text style={style.text}>Selectable date</Text>
        <Calendar
          enableSwipeMonths
  ...
  const renderCalendarWithWeekNumbersAndSpinner = () => {
    return (
      <Fragment>
        <Text style={style.text}>Week numbers and spinner</Text>
        <Calendar style={style.calendar} hideExtraDays showWeekNumbers displayLoadingIndicator/>
      </Fragment>
    );
  };
  ...
  const renderCalendarWithMinAndMaxDates = () => {
    return (
      <Fragment>
        <Text style={style.text}>Min and max dates</Text>
        <Calendar
          style={style.calendar}
          hideExtraDays
          current={INITIAL_DATE}
  ...
  const renderCalendarWithMarkedDatesAndHiddenArrows = () => {
    return (
      <Fragment>
        <Text style={style.text}>Marked dates and hidden arrows</Text>
        <Calendar
          style={style.calendar}
          current={INITIAL_DATE}
          hideExtraDays
  ...
  const renderCalendarWithMultiDotMarking = () => {
    return (
      <Fragment>
        <Text style={style.text}>Multi-dot marking</Text>
        <Calendar
          style={style.calendar}
          current={INITIAL_DATE}
  ...
  const renderCalendarWithThemeAndDisabledDays = () => {
    return (
      <Fragment>
        <Text style={style.text}>Custom theme and disabled Wednesdays</Text>
        <Calendar
          current={INITIAL_DATE}
          minDate={getDate(-5)}
  ...
  const renderCalendarWithPeriodMarkingAndDotMarking = () => {
    return (
      <Fragment>
        <Text style={style.text}>Marking and dot marking</Text>
        <Calendar
          current={INITIAL_DATE}
          minDate={getDate(-14)}
          markingType={'period'}
  ...
  const renderCalendarWithMultiPeriodMarking = () => {
    return (
      <Fragment>
        <Text style={style.text}>Multi-period marking</Text>
        <Calendar
          style={style.calendar}
          current={INITIAL_DATE}
  ...
  const renderCalendarWithCustomMarkingType = () => {
    return (
      <Fragment>
        <Text style={style.text}>Custom marking type</Text>
        <Calendar
          style={style.calendar}
          hideExtraDays
          current={INITIAL_DATE}
  ...
  const renderCalendarWithCustomDay = () => {
    return (
      <Fragment>
        <Text style={style.text}>Custom day component</Text>
        <Calendar
          style={[style.calendar, style.customCalendar]}
          dayComponent={({date, state}) => {
            return (
              <View>
                <Text style={[style.customDay, state === 'disabled' ? style.disabledText : style.defaultText]}>
                  {date?.day}
                </Text>
              </View>
            );
  ...
  const renderCalendarWithCustomHeaderTitle = () => {
    const CustomHeaderTitle = (
      <TouchableOpacity style={style.customTitleContainer} onPress={() => console.warn('Tapped!')}>
        <Text style={style.customTitle}>{selectedValue.getMonth() + 1}-{selectedValue.getFullYear()}</Text>
      </TouchableOpacity>
    );

    return (
      <Fragment>
        <Text style={style.text}>Custom header title</Text>
        <Calendar
          style={style.calendar}
  ...
  const customHeaderProps: any = useRef<{month: Date, addMonth: (add: number) => void}>({month: new Date(), addMonth: () => {}});
  ...
  const renderCalendarWithCustomHeader = () => {
    const CustomHeader = React.forwardRef((props, ref) => {
      ...
      return (
        // @ts-expect-error
        <View ref={ref} {...props} style={style.customHeader}>
    ...
    return (
      <Fragment>
        <Text style={style.text}>Custom header component</Text>
        <Calendar
  ...
  const renderCalendarWithInactiveDays = () => {
    return (
      <Fragment>
        <Text style={style.text}>Inactive days</Text>
        <Calendar
          style={style.calendar}
